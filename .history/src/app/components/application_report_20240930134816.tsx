    ...
    const downloadReport = async (e: React.FormEvent) => {
        ...
        fetch("/RMS-FORMv2.xlsx")
            ...
            .then(workbook => {
                ...
                worksheet.getCell('U109').value = data.mspowerpoint == "A" ? "Advanced / ขั้นสูง" : data.mspowerpoint == "I" ? "Intermediate / ระดับกลาง" : data.mspowerpoint == "B" ? "Basic / พื้นฐาน" : data.msword == "AAT" ? "Advanced and able to training to other / ขั้นสูงและสอนคนอื่นได้" : "";
