    ...
    const downloadReport = async (e: React.FormEvent) => {
        ...
        fetch("/RMS-FORMv2.xlsx")
            ...
            .then(workbook => {
                ...
                worksheet.getCell('U108').value = data.msexcel == "A" ? "Advanced / ขั้นสูง" : data.msexcel == "I" ? "Intermediate / ระดับกลาง" : data.msexcel == "B" ? "Basic / พื้นฐาน" : data.msword == "AAT" ? "Advanced and able to training to other / ขั้นสูงและสอนคนอื่นได้" : "";
