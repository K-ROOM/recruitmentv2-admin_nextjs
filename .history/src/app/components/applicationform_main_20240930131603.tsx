...
import FormBody1 from "./formstep1_body";
import FormBody2 from "./formstep2_body";
import FormBody3 from "./formstep3_body";
import FormBody4 from "./formstep4_body";
import FormBody5 from "./formstep5_body";
import FormBody6 from "./formstep6_body";
import FormBody7 from "./formstep7_body";
import Report from "./application_report";
                                            ...
                                            <>
                                                <div className="flex self-center px-5 pt-5 border-solid border-blueGray-200 rounded-t">
                                                    <h3 className="text-xl font-semibold">
                                                        <Image src="/check.gif" alt="Loading..." style={{ width: 150, height: 150 }} width={150} height={150} />
                                                    </h3>
                                                </div>
