            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-12 sm:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 sm:col-span-full">
                        ...
                        <input type="date" id="startingDate" name="startingDate" value={formData.startingDate === null ? '' : moment(formData.dateofBirth).set('year', moment(formData.dateofBirth).year()).format('YYYY-MM-DD')} onChange={handleInputChange} className="input-formcontrol" required />
                    </div>
                </div>
