    ...
    const downloadReport = async (e: React.FormEvent) => {
        ...
        fetch("/RMS-FORMv2.xlsx")
            ...
            .then(workbook => {
                ...
                worksheet.getCell('B24').value = data.chkMotorcycle1 == "Y" ? "Yes/ได้" : "No"
                worksheet.getCell('E24').value = data.chkMotorcycle2 == "Y" ? "Yes" : "No"
                worksheet.getCell('G24').value = data.chkMotorcycle3 == "Y" ? "Yes" : "No"
