            ...
            <form onSubmit={handleSubmit}>
                <div className="grid grid-cols-12 sm:grid-cols-2 gap-4">
                    ...
                    <div className="col-span-2 sm:col-span-full">
                        ...
                        <input type="date" id="startingDate" name="startingDate" value={formData.startingDate === null ? '' : moment(formData.startingDate).set('year', moment(formData.startingDate).year() + 543).format('YYYY-MM-DD')} onChange={handleInputChange} className="input-formcontrol" required />
                    </div>
                </div>
                ...
                <div className="grid grid-cols-12 gap-4 mt-6">
                    <div className="col-span-2 sm:col-span-full ">
                        ...
                        <input type="date" id="dateofBirth" name="dateofBirth" value={formData.dateofBirth === null ? '' : moment(formData.dateofBirth).set('year', moment(formData.dateofBirth).year() + 543).format('YYYY-MM-DD')} onChange={handleInputChange} className="input-formcontrol" required />
                    </div>
