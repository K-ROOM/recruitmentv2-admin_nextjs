                                        ...
                                        <Fragment key={index}>
                                            <div className="grid grid-cols-12 gap-2 mt-6">
                                                <div className="col-span-3 mr-2">
                                                    ...
                                                    <input type="text" id="company" name="company" value={e.company} maxLength={150} onChange={(e) => handleChangeInputWorkExperience(e, index)} className="input-formcontrol" required />
                                                </div>
