            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="grid grid-cols-12 gap-4 mt-6">
                    <div className="col-span-2 sm:col-span-full ">
                        ...
                        <input type="date" id="dateofBirth" name="dateofBirth" value={formData.dateofBirth === null ? '' : : moment(formData.dateofBirth).add(543, 'years').format('YYYY-MM-DD')} onChange={handleInputChange} className="input-formcontrol" required />
                    </div>
