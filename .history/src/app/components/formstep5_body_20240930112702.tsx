                    ...
                    <div className="grid grid-cols-12 gap-2 mt-6 mr-2">
                        ...
                        <div className="col-span-2 mr-2">
                            ...
                            <select id="msword" name="msword" value={formData.msword} className="input-formcontrol px-2" onChange={handleChangeHeader} required>
                                ...
                                <option value="F">Intermediate / ระดับกลาง</option>
                                <option value="G">Advanced / ขั้นสูง </option>
                                <option value="G">Advanced and able to training to other / ขั้นสูงและสอนคนอื่นได้</option>
                            </select>
                        </div>
                    </div>
