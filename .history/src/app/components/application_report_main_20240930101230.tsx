    ...
    const downloadReport = async (e: React.FormEvent) => {
        ...
        fetch("/RMS-FORMv2.xlsx")
            ...
            .then(workbook => {
                ...
                worksheet.getCell('B23').value = data.chkcar1 == "Y" ? "Yes/ได้" : "No"
                worksheet.getCell('E23').value = data.chkcar2 == "Y" ? "Yes" : "No"
                worksheet.getCell('G23').value = data.chkcar3 == "Y" ? "Yes" : "No"
