    ...
    const downloadReport = async (e: React.FormEvent) => {
        ...
        fetch("/RMS-FORMv2.xlsx")
            ...
            .then(workbook => {
                ...
                worksheet.getCell('U109').value = data.mspowerpoint == "A" ? "Advanced/ขั้นสูง" : data.msword == "F" ? "Intermediate/ระดับกลาง" : data.msword == "P" ? "Basic/พื้นฐาน" : "Advanced and able to training to other/ขั้นสูงและสอนคนอื่นได้";
