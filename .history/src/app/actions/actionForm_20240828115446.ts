...
export async function PatchApplicationHeader(obj: any) {
    ...
    try {
        const response = await axios.patch(process.env.NEXT_PUBLIC_API_KEY + '/rms/' + obj.recruitmentID, {...obj, dateofBirth: moment(obj.dateofBirth).format('YYYY-MM-DD') }, { headers })
